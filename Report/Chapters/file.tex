...
\subsubsection{Estimation and results}
We estimate the network penalty with the network bandwidth we have measured. \textbf{Section Network} shows that the peak network bandwidth is 112MB/s, so the network penalty for a block should be:

$$\frac{4KB}{112*1000KB/s} = 35.7us$$
